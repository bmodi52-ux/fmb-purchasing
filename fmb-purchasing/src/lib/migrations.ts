...
export const LEDGERED_MIGRATIONS = [
  ...
  "0061_menus_and_dishes.sql",
  "0062_dish_box_sizes.sql",
  "0063_menu_procurement.sql",
  "0064_box_sizes.sql",
  "0065_thaali_menu_label.sql",
  "0066_pack_disagreement.sql",
  "0067_thaali_parts.sql",
  "0068_simple_menus.sql",
  "0069_menu_tables_rls.sql",
  "0070_rejected_item_offers.sql",
